...
class PyTorchMLP(torch.nn.Module):
    def __init__(self, num_features, num_classes, hidden_units):
        ...
        print(hidden_units)
        all_layers = []
        for hid_unit in hidden_units:
            layer = torch.nn.Linear(num_features, hid_unit)
            all_layers.append(layer)
            all_layers.append(torch.nn.ReLU())
            num_features = hid_unit
...
class LightningModel(L.LightningModule):
    def __init__(self, model=None, num_features=None, num_classes=None, learning_rate=None, hidden_units=None):
        super().__init__()
        ...
        if model is None:
            ...
            self.model = PyTorchMLP(num_features=100, hidden_units=hidden_units,
                                    num_classes=2)
